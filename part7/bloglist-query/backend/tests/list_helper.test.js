...
describe('listHelper', () => {
  ...
  describe('favorite blog', () => {
    ...
    test('of a bigger list, return the correct favorite blog', () => {
  ...
  describe('most blogs', () => {
    ...
    test('of a bigger list, return the correct most blog', () => {
  ...
  describe('most likes', () => {
    ...
    test('of a bigger list, return the author, whose blog posts have the largest amount of likes', () => {
